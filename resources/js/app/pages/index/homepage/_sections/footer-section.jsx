const navigation = {
    ...
    social: [
        {
            name: "Facebook",
            href: "https://www.facebook.com/eron.kun",
            icon: (props) => (
        ...
        {
            name: "LinkIn",
            href: "https://www.linkedin.com/in/marlou-pepito-5758871b8/?originalSubdomain=ph",
            icon: (props) => (
        ...
        {
            name: "GitHub",
            href: "https://github.com/marloudev",
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        {
            name: "Upwork",
            href: "https://www.upwork.com/freelancers/~0101341a39547d2674",
            icon: (props) => (
        ...
        <footer>
            <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
                ...
                <p className="mt-10 text-center text-xs leading-5 text-gray-500">
                    &copy; 2025 Marlou Pepito. All rights reserved.
                </p>
            </div>
        </footer>
    );
