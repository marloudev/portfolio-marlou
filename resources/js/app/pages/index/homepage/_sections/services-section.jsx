...
const tiers = [
    {
        ...
        description:
            "Full-stack web solutions tailored for performance and scalability.",
        features: [
            "Responsive Design",
            "API Integration",
            "SEO Optimization",
        ...
        projects: [
            {
                ...
                description:
                    "A custom dashboard to manage client projects and invoices.",
                tech: "React, Tailwind CSS, Node.js",
            },
            {
                name: "Portfolio Site",
                description:
                    "Personal portfolio with blog and contact features.",
        ...
        projects: [
            {
                ...
                description:
                    "Offline desktop tool for managing small business inventory.",
        ...
        projects: [
            {
                ...
                description:
                    "Tracks workouts, goals, and progress with local storage.",
